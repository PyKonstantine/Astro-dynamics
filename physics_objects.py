...
class Planet(Physics):
    """Можно сделать так чтобы звезды были отдельным классом и имели свое свечение в зависимости от массы или размера. От темно красного до
    синего и белого(нужно почитать какая зависимость у цвета звезд) Планеты же тоже имели бы освещенность в зависимости
    от силы свячения звезды и расстояния до них"""
...
planets = [
    # Star system
    Planet("Sun", 5000, 50, (600, 400), (0, 0), (255, 255, 150)),
